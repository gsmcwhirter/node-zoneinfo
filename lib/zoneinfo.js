...
TZDate.listTimezones = function (country_code, force){
    country_code = country_code || "";
    if (TZDate._zoneinfo_listcache[country_code || "_"] && !force){
    ...
    if (stat.isDirectory())
    {
        if (country_code)
        {
            ...
            buffer.forEach(function (line){
                ...
                line = line.split("\t");
                if (!TZDate._zoneinfo_listcache[line[0]]) TZDate._zoneinfo_listcache[line[0]] = [];
                
                TZDate._zoneinfo_listcache[line[0]].push(line[2]);
            });
